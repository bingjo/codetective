...
import classes from './SectionCenter.css'
        ...
        return(
            <section className={classes.SectionCenter}>
                <ul className={parentClasses.UlAdvantages}>
                    <li className={parentClasses.HeadingAdvantages}>Пробный период</li>
                    ...
                    <svg width="47" height="47" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							 viewBox="0 0 512.002 512.002" enable-background = "new 0 0 512.002 512.002" xmlSpace="preserve">
						<g>
							<g>
                ...
                <h1 className={parentClasses.DescriptionAdvantages}>Бесплатный пробный период - 1 месяц. Попробуй полный функционал бесплатно и не прикладывая дополнительных усилий</h1>
            </section>
        )
    }
}
